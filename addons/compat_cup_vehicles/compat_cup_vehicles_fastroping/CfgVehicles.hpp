class CfgVehicles {
  ...
  class CUP_AW159_Unarmed_Base : Helicopter_Base_H {
    ...
    class UserActions {
      class CloseRdoor {
        condition = QUOTE(this doorPhase 'CargoDoorR' > 0.5 &&
                          ((this getCargoIndex player)isEqualTo 0) &&
                          !(this getVariable[ARR_2(
                              QUOTE(QEGVAR(fastroping, doorsLocked)), false)]));
      };
    };
  };
  ...
  class CUP_CH47F_base : Helicopter_Base_H {
    EGVAR(fastroping, enabled) = 1;
    EGVAR(fastroping, ropeOrigins)
    [] = {"ropeOriginLeft", "ropeOriginRight", "ropeOriginMid"};
  };
  ...
  class CUP_CH53E_base : Helicopter_Base_H {
    ...
    class UserActions {
      class RampClose {
        condition = QUOTE(this animationPhase 'ramp_bottom' >= 0.56 &&
                          player == driver this &&
                          !(this getVariable[ARR_2(
                              QUOTE(QEGVAR(fastroping, doorsLocked)), false)]));
      };
  ...
  class CUP_Merlin_HC3_Base : Helicopter_Base_H {
    ...
    class UserActions {
      class CloseRdoor {
        condition =
            QUOTE(this doorPhase 'dvere_p' > 0.5 &&
                  {(this getCargoIndex player)isEqualTo 0} &&
                  {!(this getVariable[ARR_2(
                      QUOTE(QEGVAR(fastroping, doorsLocked)), false)])});
      };
  ...
  class CUP_MH60S_Base : Helicopter_Base_H {
    ...
    class UserActions {
      ...
      class CloseDoors : OpenDoors {
        condition = QUOTE(this animationPhase 'doors' > 0.5 &&
                          driver this == player && alive(this) &&
                          !(this getVariable[ARR_2(
                              QUOTE(QEGVAR(fastroping, doorsLocked)), false)]));
      };
    };
  ...
  class CUP_SA330_Base : Helicopter_Base_H {
    ...
    class UserActions {
      class CloseRdoor {
        condition = QUOTE(
            alive this && {this doorPhase 'ofrp_puma_porte_droite' > 0.5} &&
            {(this getCargoIndex player)isEqualTo 0} &&
            {!(this getVariable[ARR_2(QUOTE(QEGVAR(fastroping, doorsLocked)),
                                      false)])});
      };
      class CloseLdoor {
        condition = QUOTE(alive this &&
                          {this doorPhase 'ofrp_puma_porte_gauche' > 0.5} &&
                          {(this getCargoIndex player)isEqualTo 1} &&
                          !(this getVariable[ARR_2(
                              QUOTE(QEGVAR(fastroping, doorsLocked)), false)]));
      };
    };
